...
# Replace from phase 01 output and retain the same value used by phase 02.
...
container_apps = {
  ...
  api = {
    ...
    environment_variables = {
      ...
      STORAGE_ACCOUNT_NAME                                   = "REPLACE_STORAGE_NAME"
  ...
  llmmagic = {
    ...
    environment_variables = {
      ...
      DOCMIND_LLMMAGIC_AZURE_AI_FOUNDRY_PROJECT_NAME                = "aifp-ocr-dev"
